...
<div ng-controller="user" class="modal fade" id="addRole" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 input-group mb-3">
                            ...
                            <input class="form-control" placeholder="Ej. Administrador" type="text" id="u_name" name="u_name" autocomplete="off" required>
                        </div>
